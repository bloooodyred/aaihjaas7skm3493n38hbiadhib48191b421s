  ...
  return (
    <div className="fixed inset-0 z-[60] overflow-y-auto">
      <div className="flex items-start justify-center min-h-screen pt-20 px-4 pb-20 text-center">
        ...
        <div 
          ref={modalRef}
          className="relative z-[61] inline-block w-full max-w-2xl bg-transparent rounded-lg text-left overflow-hidden shadow-xl transform transition-all my-8 align-middle scrollbar-hide"
        ...
        >
          <div className="p-4">
            <div className="relative">
              ...
              <input
                type="text"
                className="block w-full pl-10 pr-16 py-3 bg-zinc-900 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-transparent"
